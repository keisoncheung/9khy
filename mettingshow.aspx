<%@ Page Title="" Language="C#" MasterPageFile="~/mp1.master" AutoEventWireup="true" CodeFile="mettingshow.aspx.cs" Inherits="mettingshow" %>

<%@ Register Src="~/hotelsearch.ascx" TagName="left1" TagPrefix="uc1" %>
<%@ Register Src="~/citysearch.ascx" TagName="left2" TagPrefix="uc2" %>
<%@ Register Src="~/l_metting.ascx" TagName="left3" TagPrefix="uc3" %>
