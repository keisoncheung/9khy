<%@ Control Language="C#" AutoEventWireup="true" CodeFile="citysearch.ascx.cs" Inherits="citysearch" %>
<div class="uc1_left">
    <div class="knei_lefttit">
        服务热门城市</div>
    <div class="uc1_left2">
        <div style="width:98%; margin: 5px auto; text-align:center;">
