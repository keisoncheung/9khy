<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hoteladd.aspx.cs" Inherits="manager_hoteladd" ValidateRequest="false" %>
 ...
 <body>
    <form id="form1" method="post" runat="server">
       ...
       <asp:RadioButtonList ID="rbl" runat="server" RepeatDirection="Horizontal" 
            ...
            <table border=0 cellSpacing="1" cellPadding="1" style="width:758px;" align=center>
                <tr>
                    <td bgcolor="#507CD1" colspan="3">
                        <font face="宋体" color="#ffffff">::资料管理::::::::::::::::::::::::::::::</font></td>
                </tr>
                <tr>
        ...
        <font face="宋体">
            <asp:TextBox ID="tbxpeople" runat="server" Width="429px" Text="0"></asp:TextBox>
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
            <asp:TextBox ID="tbxaddr" runat="server" Width="434px"></asp:TextBox>
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
          <select style="width: 151px" runat=server id="sel_city">
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
             <select style="width: 151px" runat=server id="sel_xj">
                                        <option value="0">==请选择==</option>
                                        <option value="5">==五星级==</option>
                                        <option value="4">==四星级==</option>
                                        <option value="3">==三星级==</option>
                                        <option value="1">==经济实惠型==</option>
                                    </select>
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
            <select style="width: 151px" id="jiage" runat="server">
                                        <option value="0">==请选择==</option>
                                        <option value="300">==300-500元以下==</option>
                                        <option value="500">==500-800元以下==</option>
                                        <option value="800">==800-1500元以下==</option>
                                        <option value="1500">==1500-3000元以下==</option>
                                        <option value="3000">==3000-5000元以下==</option>
        ...
        <font face="宋体">
                        <asp:DropDownList ID="drtype" runat="server" Width="137px" AutoPostBack="True" 
                            ...
                            </asp:DropDownList><asp:DropDownList ID="drtype2" runat="server" Width="147px">
                            </asp:DropDownList>
        </font> 
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
                        <asp:TextBox ID="canshu" runat="server" Height="144px" TextMode="MultiLine" 
...
资料图片</font></td>
        ...
        <font face="宋体">
                ...
                <tr>
                    <td bgcolor="#507CD1" colspan="3">
                        <font face="宋体" color="#ffffff">::资料介绍::::::::::::::::::::::::::::::::::::::::::::::::::::::</font></td>
                </tr>
