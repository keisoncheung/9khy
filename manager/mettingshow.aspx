<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mettingshow.aspx.cs" Inherits="manager_mettingshow" %>
       ...
       <%=str_addbt%>
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="mettingadd.aspx?id={0}&amp;ac=管理">
