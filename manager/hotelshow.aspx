<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hotelshow.aspx.cs" Inherits="manager_hotelshow" %>
       ...
       <%=str_addbt%>
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="hoteladd.aspx?id={0}&amp;ac=管理">
