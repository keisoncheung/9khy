<%@ Page Title="" Language="C#" MasterPageFile="~/mp1.master" AutoEventWireup="true" CodeFile="lip2.aspx.cs" Inherits="lip2" %>
           ...
           <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
            ...
            <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
                ...
                <div class="knei_leftcen">
                      <ul>
                        <li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='lip2.aspx' title='“中国红”'>“中国红”</a></li>
<li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='lip2.aspx' title='“中国红”'>“中国红”</a></li>
                    </ul>
                </div>
            ...
            <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
                ...
                <div style="width: 98%; height: auto!important; height: 400px; min-height: 400px;">
                    <div style="width: 98%; margin: 5px auto;">
                        ...
                        <div class='khotel_nei2div_2_con'> 因其瓷种独特、工艺复杂、制作难度大而受到各方</div>
                    </div>
                </div>
            </div>
        </div>
