...
public partial class mettingkc : System.Web.UI.Page
{
    int pagemax = 6; //没页个数;
    string pagelist = "";
    string cp = "1";
                ...
                Html.Append(@"<div class='khotel_nei2div'>
                            <div style='width: 300px; float: left;'>
                                <div class='khotel_nei_imgdiv2'>
                                    <a href='mettingkcshow.aspx?pid=" + dr["id"] + @"'>
                            ...
                            <div class='khotel_nei_condiv2'>
                                <div style='width: 100%; margin: 0px auto; overflow: hidden;'>
                                    <div style='height: 45px; line-height: 45px; margin: 0px auto; overflow: hidden;'>
                                        <a href='mettingkcshow.aspx?pid=" + dr["id"] + @"'><font style='font-size: 14px; text-align: center; color: #FF4001;
