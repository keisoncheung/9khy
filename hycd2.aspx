<%@ Page Title="" Language="C#" MasterPageFile="~/mp1.master" AutoEventWireup="true" CodeFile="hycd2.aspx.cs" Inherits="hycd2" %>
           ...
           <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
            ...
            <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
                ...
                <div class="knei_leftcen">
                    <ul>
                       <li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='hycd2.aspx' title='武陵源盛美达度假酒店会议厅'>武陵源盛美达度假酒店会议厅</a></li>
<li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='hycd2.aspx' title='武陵源盛美达度假酒店会议厅'>武陵源盛美达度假酒店会议厅</a></li>
                    </ul>
                </div>
        ...
        <div style="width: 706px; float: left; margin-left: 10px;">
            <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
                ...
                <div style="width: 98%; height: auto!important; height: 400px; min-height: 400px;">
                    <div style="width: 98%; margin: 5px auto;">
                        <div class="khotel_nei2div_2">
                            <div style="width: 300px; float: left;">
                                <div class="khotel_nei_imgdiv2_2">
                                    <a href="#">
                                        <img src="pic/jiudian1.jpg" /></a></div>
                            </div>
                            <div class="khotel_nei_condiv2_2">
                                <div style="width: 100%; margin: 0px auto; overflow: hidden;">
                                     <div style="height: 45px; line-height: 45px; margin: 0px auto; overflow: hidden;">
                                        <a href="hycd2.aspx"><font style="font-size: 14px; text-align: center; color: #FF4001; font-weight: bold;">
                                            武陵源盛美达度假酒店会议厅 </font></a></div>
                        ...
                        <div class="khotel_nei2div_2_con">会议酒店客房类型客房状态 是否早餐酒店挂牌价万国会展协议价豪华双人间</div>
                    </div>
                </div>
            </div>
        </div>
