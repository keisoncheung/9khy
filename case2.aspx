<%@ Page Title="" Language="C#" MasterPageFile="~/mp1.master" AutoEventWireup="true" CodeFile="case2.aspx.cs" Inherits="case2" %>
           ...
           <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
            ...
            <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
                ...
                <div class="knei_leftcen">
                    <ul>
                       <li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='case2.aspx' title='四会、贞山九龙湖度假村会议二天'>四会、贞山九龙湖度假村会议二天</a></li>
<li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='case2.aspx' title='四会、贞山九龙湖度假村会议二天'>四会、贞山九龙湖度假村会议二天</a></li>
                    </ul>
                </div>
                            ...
                            <div class="khotel_nei_condiv2_2">
                                <div style="width: 100%; margin: 0px auto; overflow: hidden;">
                                    <div style="height: 45px; line-height: 45px; margin: 0px auto; overflow: hidden;">
                                        <a href="#"><font style="font-size: 14px; text-align: center; color: #FF4001; font-weight: bold;">
                                            四会、贞山九龙湖度假村会议二天</font></a></div>
