<%@ Page Title="" Language="C#" MasterPageFile="~/mp1.master" AutoEventWireup="true"
    CodeFile="hotalshow.aspx.cs" Inherits="hotalshow" %>
           ...
           <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
            ...
            <div style="clear: both; border: solid 1px #E2D19D; width: 100%;">
                ...
                <div class="knei_leftcen">
                    <ul>
                        <li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href='hotalshow.aspx' title='商务会议接待一般流程'>万泰国际大酒店</a></li>
<li>
                            <img src="images/874.jpg" style="margin-right: 5px; overflow: hidden;" /><a target='_blank' href=hotalshow.aspx' title='商务会议接待一般流程'>万泰国际大酒店</a></li>
                    </ul>
                </div>
                            ...
                            <div class="khotel_nei_condiv2_2">
                                <div style="width: 100%; margin: 0px auto; overflow: hidden;">
                                    ...
                                    <div style="margin: 0px auto; line-height: 20px;">
                                        酒店地址：武陵源区宝峰路8号<br />
                                        周边景点：天子山、森林公园、宝峰湖<br />
                                        酒店简介：会议酒店客房类型客房状态 是否早餐酒店挂牌价万国会展协议价豪华双人间需预定含￥3380/间￥780/间豪华...
                                    </div>
                                </div>
                            </div>
                        </div>
